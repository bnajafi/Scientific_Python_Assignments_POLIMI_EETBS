...
def WallCalculatorAssignment(WallSer,WallPar,AreaFraction):
    """This function calculates the overall resistance and conductivity of a wall with two layers in parallel"""
...
WallCalculatorAssignment(WallSer,WallPar,Area_Fraction)
