# -*- coding: utf-8 -*-
"""
Created on Fri Sep 22 20:37:15 2017
...
kbrick = float(raw_input("plz enter the brick conductivity ") )      #0.72           
kplaster = float(raw_input("plz enter the plaster conductivity "))   #0.22
kfoam = float(raw_input("plz enter the foam conductivity "))         #0.026
...
h1 = float(raw_input("plz enter the convection heat transfer coefficient inside "))  #10
h2 = float(raw_input("plz enter the convection heat transfer coefficient outside ")) #25
