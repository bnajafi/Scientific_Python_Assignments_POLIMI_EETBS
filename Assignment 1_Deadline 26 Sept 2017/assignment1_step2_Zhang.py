h1 = float(raw_input("please enter the convectivity h1 in w/m2K ")) # the convection heat transfer coefficients on the inner side
A1 = 5*(0.22+0.015+0.015) # area of the indoor heat convection
h2 = float(raw_input("please enter the convectivity h2 in w/m2K ")) # the convection heat transfer coefficients on the outer sides 
A2 = 5*(0.22+0.015+0.015) # area of the outdoor heat convection
L3 = 0.03 # the thickness of foam
k3 = float(raw_input("please enter the conductivity k3 in w/mK ")) # conductivity of foam
...
k4 =k5 =k7 =k8 = float(raw_input("please enter the conductivity k4 k5 k7 k8 in w/mK ")) # the conduction heat transfer coefficients on the plaster layers
...
k6 = float(raw_input("please enter the conductivity k6 in w/mK ")) # the conduction heat transfer coefficients on the brick
