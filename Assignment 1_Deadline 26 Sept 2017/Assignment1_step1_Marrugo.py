# -*- coding: utf-8 -*-
#              Assigment 1 Calculation of the example D
#
print "Assigment 1 Calculation of the example D \n"
#
# Input parameters
#
...
Kair=0.72# Conductivity of cross horizontal section on the brick in [W/m*ºC]
Kb=0.22# Conductivity of the plaster layers of the brick in [W/m*ºC]
Kp=0.026# Conductivity of the foam layer in [W/m*ºC]
tin=20.# Indoor temperature in [ºC] 
tout=-10.# Outdoor temperature in [ºC] 
h1=10.# Heat transfer coefficient of inner side in [W/m^2]
h2=25.# Heat transfer coefficient of outer side in [W/m^2]
#
