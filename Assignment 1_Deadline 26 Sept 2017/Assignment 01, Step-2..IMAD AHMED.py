...
# Assignment Based On Exercise-D (Heat Loss Through A Composite Wall)print "At first, we're going to calculate the rate of heat transfer through a unit of 0.25m high and 1m deep"
