...
K1 = 0.026 #Conduction heat transfer coefficienc of FOAM in W/m·°degC
K2 = 0.22 #Conduction heat transfer coefficienc of PLASTER in W/m·degC
K3 = 0.72 #Conduction heat transfer coefficienc of BRICK in W/m·degC
H1 = 10 #Convection heat transfer coefficient (into) in W/m2
H2 = 25 #Convection heat transfer coefficient (outer) in W/m2
...
print "The total thermal resistance of the unit block is "+str(Rtot)+" degC/W"
...
print "The total heat transfer across the unit block is " +str(Qunit)+ " W" " and the total heat transfer across the wall is " +str(Qwall)+ " W"
