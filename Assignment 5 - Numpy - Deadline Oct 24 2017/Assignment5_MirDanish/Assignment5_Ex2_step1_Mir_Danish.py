# Energy And Environmental Technologies For Building Systems : Assignment 05, Step-1

# Submitted By : Danish Ahmad Mir

# Assignment 05 Based On Assignment 02 (Using Numpy for resistance calculations)
...
Resistance_names = np.array(["R_1","R_2","R_f","R_p1","R_p2","R_c1","R_c2","R_b"])
...
# Heat transfer
Q_unit = (Tinf1 - Tinf2) / R_tot #total heat transfer through the wall per unit width [W]
Q_wall = round((Q_unit * (Awall/A))) #total heat transfer through the wall [W]
