# Energy And Environmental Technologies For Building Systems : Assignment 05, Step-2

# Submitted By : Danish Ahmad Mir

# Assignment 05 Based On Assignment 03 (Using Numpy to define Material Library)
...
for layerName in layerNames_Stud:
    RValue_myStud[layerNames_Stud==layerName] = materials_Rvalues[materials_names==layerName]
...
for layerName in layerNames_Fiber:
    RValue_myFiber[layerNames_Fiber==layerName] = materials_Rvalues[materials_names==layerName]
...
Tin = 22 # internal Temperature of the building
Tout = -2 # External Temperature, Winter mode for our case
Q =U_total*(Tin - Tout)
