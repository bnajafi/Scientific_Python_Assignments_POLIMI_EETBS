# -*- coding: utf-8 -*-
#Calculating total resistance using the "dictionary function ()"
#Conduction resistance in series
#Note that all area in (m2), length in (m),k in (W/m · degC), h in (W/m2)
...
for anyreslist in Cond_Res_Series:
    print 'The definitions of parameters in this material is:'
    print anyreslist
