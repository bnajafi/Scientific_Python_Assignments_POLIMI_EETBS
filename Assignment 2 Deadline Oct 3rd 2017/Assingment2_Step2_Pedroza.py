# -*- coding: utf-8 -*-
#SOLVING EXAMPLE D WITH DICTIONARIES
...
#USING DICTIONARIES
R_F= {"name":"Foam","area":0.25,"length":0.03,"k":0.026} #Resistivity of Foam -- Area, Length, Conductivity
R_P_S1= {"name":"Plaster","area":0.25,"length":0.02,"k":0.22} #Resistivity of Plaster -- Area, Length, Conductivity
R_P_S2= {"name":"Plaster","area":0.25,"length":0.02,"k":0.22} #Resistivity of Plaster -- Area, Length, Conductivity

R_B= {"name":"Brick","area":0.22,"length":0.16,"k":0.72} #Resistivity of Brick -- Area, Length, Conductivity
R_P1= {"name":"Plaster in parallel1","area":0.015,"length":0.16,"k":0.22} #Resistivity of Plaster -- Area, Length, Conductivity
R_P2= {"name":"Plaster in parallel2","area":0.015,"length":0.16,"k":0.22} #Resistivity of Plaster -- Area, Length, Conductivity

#CONVECTION
R_Conv_1={"area":0.25,"h":10} #Resistivity of inside of building -- Area, Convection coefficcient
R_Conv_2={"area":0.25,"h":25} #Resistivity of outside of building -- Area, Convection coefficcient
...
for anyR_Par in List_Par:
    A_anyR=anyR_Par["area"]
    L_anyR=anyR_Par["length"]
    k_anyR=anyR_Par["k"]
...
for anyR_Ser in List_Ser:
    A_anyR=anyR_Ser["area"]
    L_anyR=anyR_Ser["length"]
    k_anyR=anyR_Ser["k"]
